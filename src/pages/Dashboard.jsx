                        ...
                        filteredQuotes.map((quote) => {
                          ...
                          return (
                            <tr key={quote.id} style={{ borderBottom: '1px solid #f1f5f9', fontSize: '0.85rem' }}>
                              ...
                              {/* ACTIONS DROPDOWN CELL (OPENS UPWARD) */}
                                    ...
                                    <div style={{
                                      ...
                                      <div style={{ position: 'relative' }}>
                                        <button
                                          ...
                                          style={{ width: '100%', background: 'none', border: 'none', padding: '8px 14px', textAlign: isHebrew ? 'right' : 'left', cursor: 'pointer', fontSize: '0.85rem', color: '#065f46', display: 'flex', alignItems: 'center', gap: '6px', fontWeight: '500' }}
                                          onMouseEnter={(e) => e.target.style.background = '#f1f5f9'}
                                          onMouseLeave={(e) => e.target.style.background = 'none'}
                                        >
                                          <svg style={{ width: '14px', height: '14px', fill: '#065f46', flexShrink: 0 }} viewBox="0 0 24 24">
