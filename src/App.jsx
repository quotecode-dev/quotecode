...
const DEFAULT_LOGO = "data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHZpZXdCb3g9IjAgMCAyODUgMTAwIiB3aWR0aD0iMjg1IiBoZWlnaHQ9IjEwMCI+PGRlZnM+PGxpbmVhckdyYWRpZW50  dD0iTS00MCA1MCBMNzggMjAgTDg1IDM1IEw2NSA1NSBMODUgNzUgTDcw 인דקיסבלוט ";
                  ...
                  <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: isHebrew ? 'right' : 'left', minWidth: '550px' }}>
                    <thead>
                      <tr style={{ borderBottom: '2px solid #e2e8f0', color: '#64748b', fontSize: '0.75rem', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                        <th style={{ padding: '8px 6px' }}>{isHebrew ? 'מספר הצעה' : 'Quote #'}</th>
                        <th style={{ padding: '8px 6px' }}>{isHebrew ? 'לקוח' : 'Client'}</th>
                        <th style={{ padding: '8px 6px' }}>{t.status}</th>
                        <th style={{ padding: '8px 6px' }}>{t.total}</th>
                        <th style={{ padding: '8px 6px' }}>{t.validUntil}</th>
                        ...
                        filteredQuotes.map((quote) => {
                          ...
                          return (
                            <tr key={quote.id} style={{ borderBottom: '1px solid #f1f5f9', fontSize: '0.85rem' }}>
                              ...
                              <td style={{ padding: '10px 6px', fontWeight: '600', color: '#1e293b', fontSize: '0.85rem' }}>
                                ...
                                <div style={{ display: 'flex', alignItems: 'center', gap: '4px', flexDirection: isHebrew ? 'row-reverse' : 'row', justifyContent: isHebrew ? 'flex-start' : 'flex-end', flexWrap: 'nowrap' }}>
                                  ...
                                  <div style={{ position: 'relative', display: 'inline-block' }}>
                                    <button 
                                      ...
                                      style={{ background: '#d1fae5', color: '#065f46', border: 'none', padding: '0 8px', borderRadius: '4px', cursor: 'pointer', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', height: '26px', boxSizing: 'border-box', width: '28px' }}
                                    >
                                  ...
                                  <button 
                                    ...
                                    style={{ background: '#dbeafe', color: '#1e40af', border: 'none', padding: '0 8px', borderRadius: '4px', cursor: 'pointer', fontWeight: 'bold', fontSize: '0.75rem', height: '26px', boxSizing: 'border-box', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', width: '28px' }}
                                  >
                                    @
                                  </button>
